...
export const SKILLS = [
  ...
  {
    id: "skill_wanjianqianfa_new",
    name: "万箭齐发(加强版)",
    type: "active",
    target: "enemy_group",
    effect: "【6/24重做】发动率35%（原40%）。目标群体2（有效距离内2个，原全体）。对敌军群体发动一次攻击（伤害率75%-150%，原90%-180%），并使敌军群体进行策略攻击的伤害降低50%，持续1回合。",
    cooldown: 1,
    tags: ["主动", "物理输出", "群体", "降策略伤害", "加强"],
    heroes: [],
    quality: "强力",
    description: "【6/24重做】瞬发取消→准备1回合，目标全体→群体2，伤害180%→150%，新增敌军群体策略攻击伤害降低50%！战略价值重新定义！",
    stars: 5
  },
  {
    id: "skill_xianshengduoren_new",
    name: "先声夺人(加强版)",
    type: "passive",
    target: "self",
    effect: "【6/24加强】前3回合，每回合自身行动时有30%-60%几率获得：连击+分兵（伤害率35%-70%，原30%-60%）+单体攻击（伤害率55%-110%，原35%-70%）。每种效果独立判定。新增攻心效果：降低敌军策略伤害。",
    cooldown: 0,
    tags: ["被动", "物理输出", "分兵", "连击", "攻心", "加强"],
    heroes: [],
    quality: "极强",
    description: "【6/24加强】分兵伤害60%→70%，单体伤害70%→110%！新增攻心效果，开荒效率大幅提升！物理核心追击技能！",
    stars: 5
  },
  {
    id: "skill_chendao_1",
    ...
    type: "chase",
    target: "enemy",
    effect: "【6/24加强】有效距离4→5。伤害无视兵种相克及防御；对敌军单体发动1次攻击（伤害率150%-300%，原140%-280%），使目标犹豫1回合；每受1次攻击追加攻击（伤害率60%-120%，原40%-80%），最多2次（原3次）。",
    cooldown: 0,
    tags: ["追击", "物理输出", "犹豫", "控制", "加强"],
    heroes: ["陈到"],
    quality: "极强",
    description: "【6/24加强】战法距离+1，大营无需宝物！伤害大幅提升！追击次数略微减少但单次伤害更高！蜀国物理追击核心！",
    stars: 5
  },
  {
    id: "skill_fazheng_1_new",
    name: "难知如阴(加强版)",
    type: "passive",
    target: "friend_single",
    effect: "【6/24加强】每2回合使友军单体（→第3回合起友军全体）主动主战法发动率提高60%-120%，如有准备则有30%-60%（受速度影响，原37.5%-75%）几率跳过1回合准备。",
    cooldown: 0,
    tags: ["被动", "辅助", "加速", "全队增益", "加强"],
    heroes: ["法正"],
    quality: "强力",
    description: "【6/24加强】目标改为友军全体！跳过准备概率受速度影响（速度越高越稳定）！蜀智队核心或将复苏！",
    stars: 5
  },
  {
    id: "skill_xuwei_sp_1_new",
    name: "破阵强袭(加强版)",
    type: "chase",
    target: "enemy",
    effect: "【6/24加强】普攻后对目标再次策略攻击（伤害率65%-130%，原59.5%-119%），暴走概率25%-50%（原20%-40%），暴走目标改为距离3内随机敌军（非攻击目标）。每次造成伤害使自身策略伤害提高2.5%-5%，最高6次。",
    cooldown: 0,
    tags: ["追击", "谋略输出", "暴走", "叠加", "加强"],
    heroes: ["徐庶SP"],
    quality: "极强",
    description: "【6/24大幅加强】伤害+11%，暴走概率+10%，暴走命中更稳定！距离3内随机目标避免空技能！SP蜀骑有望再现！",
    stars: 5
  },
  {
    id: "skill_hufang_1_new",
    name: "率尔方雅(加强版)",
    type: "active",
    target: "all",
    effect: "【6/24加强】发动率40%（原35%）。对自身外随机3名武将造成攻击伤害10%，友军→使其增伤11%-22%+立即对敌军群体攻击（伤害率90%-180%，原80%-160%，伤害类型自适应，取攻击/谋略高者）；敌军→随机陷入犹豫/怯战/混乱/暴走1回合。",
    cooldown: 1,
    tags: ["主动", "辅助", "爆发", "控制", "加强"],
    heroes: ["胡芳"],
    quality: "强力",
    description: "【6/24加强】发动率+5%，伤害90%-180%，伤害类型自适应！物理/谋略双体系均可适配！晋国强力辅助！",
    stars: 5
  },
  {
    ...
    type: "passive",
    target: "self",
    effect: "【6/24加强】受到所有伤害降低42%-84%。每受到攻击/谋略伤害后减伤效果降低1/12；前2回合援护友军全体。受伤后50%几率叠攻/防/谋10%-20%，首次受伤时必定触发且额外触发1次（原仅50%几率）。",
    cooldown: 0,
    tags: ["被动", "肉盾", "减伤", "援护", "加强"],
    heroes: ["周泰"],
    quality: "强力",
    description: "【6/24加强】首次受伤必叠属性+额外叠1层！前排稳定性大幅提升！吴国核心前排！",
    stars: 5
  }
];
