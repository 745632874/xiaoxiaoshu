...
export const SKILLS = [
  ...
  // ===== 5/20版本新增战法 =====
  {
    ...
    type: "command",
    target: "me",
    effect: "【5/20新武将】战斗开始后，令友军全体造成的策略伤害提升40.0%（受谋略属性影响），每回合结束时降低1/6；同时，友军全体造成策略伤害时，令其伤害率在原基础的80.0%-150.0%（上限受谋略属性影响）范围内随机浮动，浮动范围每回合收敛1/6，第六回合收敛至115.0%（受谋略属性影响），持续到战斗结束。",
    cooldown: 0,
    tags: ["指挥", "谋略输出", "增伤", "辅助", "新武将", "波动增伤"],
    heroes: ["刘徽"],
    quality: "极强",
    description: "【5/20新武将】全新指挥战法！友军全体策略伤害+40%（受谋略影响），每回合衰减1/6；同时令伤害率在80%-150%范围随机浮动（受谋略影响），每回合收敛。是当前版本最强谋略辅助之一！",
    stars: 5
  },
  {
    id: "skill_liuhui_2",
    ...
    type: "passive",
    target: "me",
    effect: "【5/20新武将·内政】施政后，每日交易的前500000资源，交易比率提升至100%。",
    cooldown: 0,
    tags: ["内政", "资源", "新武将"],
    heroes: ["刘徽"],
    quality: "强力",
    description: "【5/20新武将·内政技能】前期无损资源转换神器！每日50W资源100%交易比率，相当于每天无损转换大量资源，曹丕哭了！",
    stars: 5
  },
  {
    id: "skill_huangzhong_1",
    name: "定军扬威(加强版)",
    type: "active",
    target: "enemy",
    effect: "【5/20加强】发动率45%，战法距离3（原2）。对敌军群体发动一次攻击（伤害率60%-120%，原50%-100%），并进行挑衅，同时使自身受到攻击的伤害降低12.5%-25.0%（受防御属性影响）。",
    cooldown: 1,
    tags: ["主动", "物理输出", "挑衅", "加强"],
    heroes: ["黄忠"],
    quality: "强力",
    description: "【5/20加强】战法距离2→3，伤害率50%-100%→60%-120%！黄忠加强后不再是短腿武将，可以安心站在中军安全输出，伤害也大幅提升！",
    stars: 5
  },
  {
    id: "skill_dengai_1",
    ...
    type: "active",
    target: "enemy",
    effect: "【5/20加强】发动率45%（原40%）。对敌军群体发动一次攻击（伤害率80%-160%，原75%-150%），并使其陷入动摇状态，每回合产生逃兵（伤害率40%-80%），持续1回合，同时使其士气降低5→10。",
    cooldown: 1,
    tags: ["主动", "物理输出", "动摇", "减士气", "加强"],
    heroes: ["邓艾"],
    quality: "强力",
    description: "【5/20加强】发动率40%→45%，伤害率75%-150%→80%-160%！邓艾加强后稳定性大幅提升，动摇效果配合逃兵是魏国控制体系的核心！",
    stars: 5
  }
];
